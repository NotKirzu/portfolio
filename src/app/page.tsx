        ...
        <div className="relative rounded-xl border border-foreground/10 bg-background/50 backdrop-blur-md shadow-2xl overflow-hidden">
          ...
          <div className="p-8 font-mono text-sm md:text-base space-y-4">
            ...
            <p className="text-primary/65 leading-relaxed ml-6">
              ...
              servers and plugins where performance, stability, and clean design
              actually matter. That experience shaped how I approach software
              today. Now I mainly work on full-stack projects using TypeScript
              and modern web technologies, building systems that are
              maintainable, scalable, and focused on real user experience.
            </p>
